...
def truncate_qwen_tokens(text: str, max_token: int, start_token: int = 0) -> str:
    return TOKENIZER.truncate(text, max_token, start_token)


if __name__ == "__main__":
    print(TOKENIZER.count_tokens("你好，我是Qwen。"))
